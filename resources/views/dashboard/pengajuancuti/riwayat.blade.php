                                ...
                                <tbody>
                                    @forelse ($list as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-secondary text-sm font-weight-normal">{{ $item->keterangan }}
                                                </p>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle text-center ">
                                                @if ($item->status == 'Accept')
                                                    <span
                                                        class="badge badge-lg border border-info text-info bg-info rounded-1">{{ $item->status }}</span>
                                                @elseif($item->status == 'Pending')
                                                    <span
                                                        class="badge badge-lg border border-warning text-warning bg-warning rounded-1">{{ $item->status }}</span>
                                                @elseif($item->status == 'Reject')
                                                    <span
                                                        class="badge badge-lg border border-danger text-danger bg-danger rounded-1">{{ $item->status }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty
