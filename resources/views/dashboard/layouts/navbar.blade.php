<nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded position-sticky   mt-4 left-auto top-1 z-index-sticky bg-gradient-dark" id="navbarBlur" navbar-scroll="true">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item dropdown ps-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0" id="a" data-bs-toggle="dropdown" aria-expanded="false">
