                        ...
                        <table class="table table-hover align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center ms-1">
                                                <h6 class="mb-0 text-sm font-weight-semibold">{{ $item->n_depan . ' ' . $item->n_belakang }}</h6>
                                    ...
                                    <td >
                                        <p class="text-secondary text-sm font-weight-normal">{{ $item->jabatan->n_jabatan }}</p>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-sm font-weight-normal">{{ $item->no_hp }}</span>
                                    </td>
                                    <td class="text-center align-middle bg-transparent border-bottom">
                                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#editpegawai-{{ $item->id }}"><i class="fa-solid fa-pencil"></i></button>
