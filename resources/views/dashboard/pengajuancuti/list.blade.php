                    ...
                    <div class="table-responsive p-0 ">
                        <table class="table table-hover  align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center text-secondary text-sm font-weight-normal">{{ $loop->iteration }}</td>
                                    <td>
                                    ...
                                    <td c>
                                        <p class="text-center text-secondary text-sm font-weight-normal">0</p>
                                    </td>
                                    <td class="text-center align-middle bg-transparent border-bottom">
                                        <a href="/assets/file/pengajuan-cuti/{{ $item->surat }}" class="btn btn-outline-dark" download="Surat-Cuti-{{ $item->user->karyawan->n_depan }}">Unduh</a>
                                </td>
                                    <td >
                                    ...
                                    <td class="text-center align-middle bg-transparent border-bottom">
                                        <button type="submit" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#addjabatan" >Reject</button>
                                        <form action="/dashboard/list-pengajuan-cuti/{{ $item->id }}" method="post" class="d-inline">
                                            @csrf
                                            <input type="text" name="status" id="status" hidden value="Accept">
