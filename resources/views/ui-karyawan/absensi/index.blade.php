        ...
        <div class="card border shadow-lg">
            <div class="card-header bg-dark border-bottom pb-0">
                <div class="d-sm-flex align-items-center">
                    <div>
                        <h6 class="text-white  mb-0"> Hari Ini {{ $date }}
                            <span id="clock"></span>
                        </h6>
                        <p class="text-sm"></p>
                    </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" name="entry_time" id="entry_time"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" id="entry_loc" name="entry_loc"
                                        placeholder="Locaton Loading..." disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center " name="entry_ip" id="entry_ip"
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="entry_location">Lokasi Absensi</label>
                                    <input type="text" class="form-control text-center bg-dark text-white"
                                        value="{{ $absensi->entry_location }}" name="entry_location" id="entry_location"
                                        placeholder="..." disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $absensi->entry_ip }}"
                                        class="form-control text-center bg-dark text-white" name="entry_ip" id="entry_ip"
                                        placeholder="X.X.X.X" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" name="exit_time" id="exit_time"
                                        placeholder="--:--:--" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" id="exit_loc" name="exit_loc"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" name="exit_ip" id="exit_ip"
                                        placeholder="X.X.X.X" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exit_time">Waktu Selesai</label>
                                    <input type="text" class="form-control text-center bg-dark text-white"
                                        name="exit_time" value="{{ $absensi->updated_at->format('d-m-Y,  H:i:s') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exit_location">Lokasi Selesai</label>
                                    <input type="text" class="form-control text-center bg-dark text-white"
                                        name="exit_location" value="{{ $absensi->exit_location }}" id="exit_location"
                                        placeholder="..." disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
